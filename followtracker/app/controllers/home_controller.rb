class HomeController < ApplicationController
  ...
  def capital_markets
    ...
    f_companyName = @filings_page.at(".companyName").text.split("CIK")[0]
    f_companyCIK = @filings_page.at(".companyName").text.split("#:")[1].split(" ")[0]
    
    
    f_filing_links = @filings_page.search(".tableFile2/tr/td/a")
    
    print "count the links:"
    print f_filing_links.count
    @filing_info = []
